...
import com.ztore.plugin.listeners.MyProjectManagerListener.Companion.projectInstance
import com.intellij.openapi.roots.ProjectRootManager
import com.intellij.psi.PsiDirectory
import com.intellij.psi.PsiFileFactory
import com.intellij.psi.PsiManager
import org.jetbrains.kotlin.idea.KotlinLanguage
import other.ztoreTemplate.src.app_package.someActivity
import other.ztoreTemplate.src.app_package.someActivityLayout

fun RecipeExecutor.ztoreTemplate(
  ...
  generateManifest(moduleData, activityClass, activityTitle, packageName,
      ...
      requireTheme = false, useMaterial2 = false)
